function code2svg_(code) {
  const svg = codes_[code][0];
  if (svg && svg.match(/^[0-9][0-9][0-9]\.svg$/)) {
    return `https://www.jma.go.jp/bosai/forecast/img/${svg}`;
  }
  return "";
}

function code2icon_(code) {
  const text = codes_[code][5];
  return text || "";
}

function code2text_(code) {
  const text = codes_[code][3];
  return text || "";
}

function code2words_(code) {
  const text = codes_[code][4];
  if (text) {
...
function dispIdx_(res) {
  const data = JSON.parse(res.getContentText())[0].timeSeries[2];
  const temps = data.areas[0].temps;
  if (temps.length === 2) {
    return 1;
  }
  return 0;
...
function getCode_(res) {
  const data = JSON.parse(res.getContentText())[0].timeSeries[0];
  //console.log(data.timeDefines[1])
  console.log(code2words_(data.areas[0].weatherCodes[0]));
  console.log(data.timeDefines[0]);
  return data.areas[0].weatherCodes[dispIdx_(res)];
}

function getText_(res) {
  const data = JSON.parse(res.getContentText())[0].timeSeries[0];
  //console.log(data.timeDefines[1])
  console.log(code2words_(data.areas[0].weatherCodes[0]));
  console.log(data.areas[0].weathers[0]);
  return data.areas[0].weathers[dispIdx_(res)].replace(/　/g, " ");
}

function getTemp_(res) {
  const data = JSON.parse(res.getContentText())[0].timeSeries[2];
  //console.log(data.timeDefines[1])
...
function myFunction() {
  ...
  const code = getCode_(res);
  const text = getText_(res);
  const temps = getTemp_(res);

  /*let img = ""
  const words = code2words_(code)
  if (words) {
    const res = UrlFetchApp.fetch(`https://source.unsplash.com/1500x600/?${words}`, {
      method: 'get',
      followRedirects: false
    })
    img = res.getHeaders()['Location'].replace(/&q=[0-9]+/, "")
    img = `${img}&auto=compress,format&q=10&blur=20`
    console.log(img)
  }*/
  const props = PropertiesService.getScriptProperties();
  UpdateHeader.update({
    apiKey: props.getProperty("notion_api_key"),
    id: props.getProperty("notion_page_id"),
    kind: "page",
    //cover: img,
    // icon: { type: 'external', external: { url: svg } },
    icon: code2icon_(code),
    title: `${temps[1]} ${temps[0]}\n${text}`,
  });
}

const codes_ = {
  100: ["100.svg", "500.svg", "100", "晴", "CLEAR", "☀️"],
  101: ["101.svg", "501.svg", "100", "晴時々曇", "PARTLY CLOUDY", "🌤️"],
  102: [
    "102.svg",
    "502.svg",
    "300",
  ...
  104: ["104.svg", "504.svg", "400", "晴一時雪", "CLEAR, SNOW FLURRIES", "🌨️"],
  105: [
    "104.svg",
    "504.svg",
    "400",
  ...
  114: ["112.svg", "512.svg", "300", "晴後雨", "CLEAR,RAIN LATER", "🌦️"],
  115: [
    "115.svg",
    "515.svg",
    "400",
  ...
  117: ["115.svg", "515.svg", "400", "晴後雪", "CLEAR,SNOW LATER", "🌨️"],
  118: [
    "112.svg",
    "512.svg",
    "300",
  ...
  200: ["200.svg", "200.svg", "200", "曇", "CLOUDY", "☁️"],
  201: ["201.svg", "601.svg", "200", "曇時々晴", "MOSTLY CLOUDY", "🌥️"],
  202: [
    "202.svg",
    "202.svg",
    "300",
  ...
  209: ["200.svg", "200.svg", "200", "霧", "FOG", "🌫️"],
  210: [
    "210.svg",
    "610.svg",
    "200",
  ...
  211: ["210.svg", "610.svg", "200", "曇後晴", "CLOUDY, CLEAR LATER", "🌥️"],
  212: [
    "212.svg",
    "212.svg",
    "300",
  ...
  214: ["212.svg", "212.svg", "300", "曇後雨", "CLOUDY, RAIN LATER", "🌧️"],
  215: [
    "215.svg",
    "215.svg",
    "400",
  ...
  217: ["215.svg", "215.svg", "400", "曇後雪", "CLOUDY, SNOW LATER", "🌨️"],
  218: [
    "212.svg",
    "212.svg",
    "300",
  ...
  300: ["300.svg", "300.svg", "300", "雨", "RAIN", "☂️"],
  301: ["301.svg", "701.svg", "300", "雨時々晴", "RAIN, PARTLY CLOUDY", "🌧️"],
  302: [
    "302.svg",
    "302.svg",
    "300",
  ...
  304: ["300.svg", "300.svg", "300", "雨か雪", "RAINORSNOW", "🌨️"],
  306: ["300.svg", "300.svg", "300", "大雨", "HEAVYRAIN", "☔"],
  308: ["308.svg", "308.svg", "300", "雨で暴風を伴う", "RAINSTORM", "🌀"],
  309: ["303.svg", "303.svg", "400", "雨一時雪", "RAIN,OCCASIONAL SNOW", "🌨️"],
  311: ["311.svg", "711.svg", "300", "雨後晴", "RAIN,CLEAR LATER", "🌧️"],
  313: ["313.svg", "313.svg", "300", "雨後曇", "RAIN,CLOUDY LATER", "🌧️"],
  314: [
    "314.svg",
    "314.svg",
    "400",
  ...
  315: ["314.svg", "314.svg", "400", "雨後雪", "RAIN,SNOW LATER", "🌨️"],
  316: [
    "311.svg",
    "711.svg",
    "300",
  ...
  340: ["400.svg", "400.svg", "400", "雪か雨", "SNOWORRAIN", "🌨️"],
  350: ["300.svg", "300.svg", "300", "雨で雷を伴う", "RAIN AND THUNDER", "⛈️"],
  361: [
    "411.svg",
    "811.svg",
    "400",
  ...
  400: ["400.svg", "400.svg", "400", "雪", "SNOW", "❄️"],
  401: ["401.svg", "801.svg", "400", "雪時々晴", "SNOW, FREQUENT CLEAR", "🌨️"],
  402: [
    "402.svg",
    "402.svg",
    "400",
  ...
  405: ["400.svg", "400.svg", "400", "大雪", "HEAVYSNOW", "❄️"],
  406: ["406.svg", "406.svg", "400", "風雪強い", "SNOWSTORM", "❄️"],
  ...
  411: ["411.svg", "811.svg", "400", "雪後晴", "SNOW,CLEAR LATER", "🌨️"],
  413: ["413.svg", "413.svg", "400", "雪後曇", "SNOW,CLOUDY LATER", "🌨️"],
  414: ["414.svg", "414.svg", "400", "雪後雨", "SNOW,RAIN LATER", "🌨️"],
  420: [
    "411.svg",
    "811.svg",
    "400",
  ...
  426: ["400.svg", "400.svg", "400", "雪後みぞれ", "SNOW, SLEET LATER", "❄️"],
  427: [
    "400.svg",
    "400.svg",
    "400",
  ...
  450: ["400.svg", "400.svg", "400", "雪で雷を伴う", "SNOW AND THUNDER", "❄️"],
};
